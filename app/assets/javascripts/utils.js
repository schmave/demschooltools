...
define (['jquery', 'jquery-ui', 'jquery-form', 'handlebars', 'sorttable', 'bootstrap'], function($) {
    ...
    // in a textfield.
    module.TEXT_AREA_EVENTS = "change keyup paste cut";

    module.enableTagBox = function(input_box, destination_div, person_id) {
