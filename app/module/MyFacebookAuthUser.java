...
public class MyFacebookAuthUser extends BasicOAuth2AuthUser implements
    ...
    public MyFacebookAuthUser(final JsonNode node, final MyFacebookAuthInfo info,
            final String state) {
    ...
    public String getProvider() {
        return MyFacebookAuthProvider.PROVIDER_KEY;
    }
