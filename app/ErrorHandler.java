...
public class ErrorHandler extends DefaultHttpErrorHandler {
    ...
    public ErrorHandler(
        ...
        mRollbarConfig = ConfigBuilder.withAccessToken(config.getString("rollbar_token"))
...
//            Http.RequestHeader request, Throwable e) {
    public CompletionStage<Result> onProdServerError(
            Http.RequestHeader request, UsefulException e) {
        ...
        return CompletableFuture.completedFuture(
            Results.internalServerError("<html><body style='font-size: 1.3em; background-color: #ebe2ff'>" +
                    ...
                    "<a href=\"mailto:schmave@gmail.com\">schmave@gmail.com</a>.</p>").as("text/html"));
    }


    private static void getRequestInfo(Http.RequestHeader request, StringBuilder sb, Map<String, Object> rollbarInfo) {
