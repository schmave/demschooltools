...
public class Accounting extends Controller {
    ...
    public Result transaction(Integer id, Http.Request request) {
        ...
        return ok(views.html.transaction.render(OrgConfig.get(Organization.getByHost(request)), transaction, form));
    }
    ...
    public Result newTransaction(Http.Request request) {
        ...
        return ok(views.html.create_transaction.render(OrgConfig.get(Organization.getByHost(request)), form));
    }
    ...
    public Result makeNewTransaction(Http.Request request) {
        ...
        if (filledForm.hasErrors()) {
            ...
            return badRequest(views.html.create_transaction.render(OrgConfig.get(Organization.getByHost(request)), filledForm));
        } else {
            try {
    ...
    public Result balances(Http.Request request) {
        ...
        return ok(views.html.balances.render(OrgConfig.get(Organization.getByHost(request)), personalAccounts, nonPersonalAccounts));
    }

    @Secured.Auth(UserRole.ROLE_ACCOUNTING)
    public Result bankCashBalance(Http.Request request) {
        applyMonthlyCredits(Organization.getByHost(request));
        return ok(views.html.bank_cash_balance.render(OrgConfig.get(Organization.getByHost(request)), TransactionList.allCash(Organization.getByHost(request))));
    }

    @Secured.Auth(UserRole.ROLE_ACCOUNTING)
    public Result transactionsReport(Http.Request request) {
        applyMonthlyCredits(Organization.getByHost(request));
        return ok(views.html.transactions_report.render(OrgConfig.get(Organization.getByHost(request)), TransactionList.blank()));
    }
    ...
    public Result runTransactionsReport(Http.Request request) throws IOException {
        ...
        if (filledForm.hasErrors()) {
            System.out.println("ERRORS: " + filledForm.errorsAsJson().toString());
            return badRequest(views.html.transactions_report.render(OrgConfig.get(Organization.getByHost(request)), TransactionList.blank()));
        }
        ...
        if (action.equals("download")) {
            ...
            return ok(views.html.transactions_report.render(OrgConfig.get(Organization.getByHost(request)), report));
        }
    }
    ...
    public Result report(Http.Request request) {
        applyMonthlyCredits(Organization.getByHost(request));
        return ok(views.html.accounting_report.render(OrgConfig.get(Organization.getByHost(request)), new AccountingReport()));
    }
    ...
    public Result runReport(Http.Request request) {
        ...
        if (filledForm.hasErrors()) {
            System.out.println("ERRORS: " + filledForm.errorsAsJson().toString());
            return badRequest(views.html.accounting_report.render(OrgConfig.get(Organization.getByHost(request)), new AccountingReport()));
        }
        AccountingReport report = AccountingReport.create(filledForm, Organization.getByHost(request));
        return ok(views.html.accounting_report.render(OrgConfig.get(Organization.getByHost(request)), report));
    }
    ...
    public Result account(Integer id, Http.Request request) {
        ...
        return ok(views.html.account.render(OrgConfig.get(Organization.getByHost(request)), account));
    }
    ...
    public Result accounts(Http.Request request) {
        ...
        return ok(views.html.accounts.render(OrgConfig.get(Organization.getByHost(request)), accounts));
    }
    ...
    public Result makeNewAccount(Http.Request request) {
        ...
        if (filledForm.hasErrors()) {
            System.out.println("ERRORS: " + filledForm.errorsAsJson().toString());
            return badRequest(views.html.new_account.render(OrgConfig.get(Organization.getByHost(request)), filledForm));
        }
        else {
    ...
    public Result editAccount(Integer id, Http.Request request) {
        ...
        return ok(views.html.edit_account.render(OrgConfig.get(Organization.getByHost(request)), form, account.is_active));
    }
