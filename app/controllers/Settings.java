...
public class Settings extends Controller {
    ...
    public Result viewSettings(Http.Request request) {
        ...
        return ok(views.html.view_settings.render(Application.currentUsername(request), OrgConfig.get(Organization.getByHost(request)), rules, Organization.getByHost(request), Public.sConfig.getConfig("school_crm")));
    }
    ...
    public Result viewTaskLists(Http.Request request) {
        ...
        return ok(views.html.view_task_lists.render(Application.currentUsername(request), OrgConfig.get(Organization.getByHost(request)), TaskList.allForOrg(Organization.getByHost(request)), list_form));
    }
    ...
    public Result viewTaskList(Integer id, Http.Request request) {
        ...
        return ok(views.html.settings_task_list.render(Application.currentUsername(request), OrgConfig.get(Organization.getByHost(request)), 
    ...
    public Result editTask(Integer id, Http.Request request) {
        ...
        return ok(views.html.edit_task.render(Application.currentUsername(request), OrgConfig.get(Organization.getByHost(request)), filled_form,
    ...
    public Result viewAccess(Http.Request request) {
        ...
        return ok(views.html.view_access.render(Application.currentUsername(request), OrgConfig.get(Organization.getByHost(request)), users_to_show, allowed_ip, user_form));
    }
    ...
    public Result editUser(Integer id, Http.Request request) {
        ...
        Form<User> user_form = mFormFactory.form(User.class);
        return ok(views.html.edit_user.render(Application.currentUsername(request), OrgConfig.get(Organization.getByHost(request)), u, user_form.fill(u)));
    }
