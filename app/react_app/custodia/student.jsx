...
class Student extends React.Component {
  constructor(props) {
    ...
    this.missingSwipeCollectorRef = React.createRef();
    this.studentEditorRef = React.createRef();
  ...
  signIn = () => {
    const helper = this.missingSwipeCollectorRef.current;
    if (helper) {
      helper.validateSignDirection(this.state.student, "in");
    }
  };
  ...
  signOut = () => {
    const helper = this.missingSwipeCollectorRef.current;
    if (helper) {
      helper.validateSignDirection(this.state.student, "out");
    }
  };
  ...
  toggleEdit = () => {
    if (userStore.isAdmin() && this.studentEditorRef.current) {
      this.studentEditorRef.current.edit(this.state.student);
    }
  };
  ...
  render() {
    if (this.state.student) {
      ...
      return (
        <div className="row">
          <StudentEditor ref={this.studentEditorRef} />
          <SwipeHelpers ref={this.missingSwipeCollectorRef} />
