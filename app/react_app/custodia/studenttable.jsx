...
module.exports = class extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = { students: studentStore.getStudents(true) };
  ...
  signIn = (student) => {
    ...
    if (helper) {
      helper.validateSignDirection(student, "in");
    }
  };
  ...
  signOut = (student) => {
    const helper = this.missingSwipeCollectorRef.current;
    if (helper) {
      helper.validateSignDirection(student, "out");
    }
  };
  ...
  render() {
    ...
    return (
      <div className="row">
        <SwipeHelpers ref={this.missingSwipeCollectorRef}></SwipeHelpers>
