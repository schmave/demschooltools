...
public class GoogleAuthProvider extends OAuth2AuthProvider<GoogleAuthUser, GoogleAuthInfo> {
  ...
  protected GoogleAuthUser transform(final GoogleAuthInfo info, final String state)
    ...
    final WSResponse r =
        fetchAuthResponse(
            url, new QueryParam(OAuth2AuthProvider.Constants.ACCESS_TOKEN, info.getAccessToken()));
  ...
  @Override
  protected GoogleAuthInfo buildInfo(final WSResponse r) throws AccessTokenException {
