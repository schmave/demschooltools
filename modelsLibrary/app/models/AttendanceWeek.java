...
public class AttendanceWeek extends Model {
  ...
  public static Finder<Integer, AttendanceWeek> find = new Finder<>(AttendanceWeek.class);
  ...
  public static AttendanceWeek findOrCreate(Date day, Person person) {
    ...
    AttendanceWeek result =
        AttendanceWeek.find.query().where().eq("person", person).eq("monday", monday).findOne();
