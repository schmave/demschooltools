...
public class NotificationRule extends Model {
  ...
  public static Finder<Integer, NotificationRule> find = new Finder<>(NotificationRule.class);
  ...
  public static List<NotificationRule> findByType(int type, Organization org) {
    return find.query().where().eq("organization", org).eq("theType", type).findList();
  }
