...
public class MailchimpSync extends Model {
  ...
  public static Finder<Integer, MailchimpSync> find = new Finder<>(MailchimpSync.class);

  public static MailchimpSync create(
      Tag t, String mailchimpListId, boolean syncLocalAdds, boolean syncLocalRemoves) {
