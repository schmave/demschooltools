...
-- update students set name='Galak Daklanwhere' _id=4;
...
-- update students set name='Elayne Janinwhere' _id=8;
...
-- update students set name='Burin Cruzwhere' _id=12;
...
-- update students set name='Herub Arcturuswhere' _id=16;
...
-- update students set name='Stanza Eisahnwhere' _id=20;
...
-- update students set name='Nil Sunspotwhere' _id=24;
