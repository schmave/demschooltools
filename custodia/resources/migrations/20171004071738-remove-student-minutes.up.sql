...
--;;
DROP FUNCTION IF EXISTS overseer.student_newest_required_minutes(BIGINT,DATE);
--;;
...
BEGIN
  ...
  BEGIN
    ...
    LEFT JOIN (SELECT * FROM overseer.student_newest_required_minutes($1,a.days)) stumin ON (1=1)
